...
Dataset_names_path = "model_data/chars_overlay_subset_labels.txt"
Dataset_train = "model_data/chars_overlay_subset_train.txt"
Dataset_test = "model_data/chars_overlay_subset_test.txt"
is_subfolder = False
